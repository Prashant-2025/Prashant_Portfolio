...
const timeline = [
  {
    ...
    desc: "Currently working as an Full Stack Developer at Clikon Technologies Private Limited, building dynamic, scalable, and high-performance web applications. Proficient in Angular and React for frontend development, combined with Node.js for backend solutions. Passionate about creating responsive, user-friendly, and optimized web experiences.",
    iconPath: "Clikon.jpeg",
    path: "http://www.clikontechnologies.in/",
  },
  {
    year: "2020-2022",
    title: "Master's Degree",
    desc: "Completed my MCA from G.L. Bajaj Institute of Technology And Management, where I spent countless nights debugging, optimizing, and surviving deadlines. Specialized in AI, cloud computing, and software development while working on projects that made me question my life choices (but in a good way).",
    iconPath: "GLB-Logo.jpg",
    path: "https://www.glbitm.org/",
  },
  {
    year: "2017-2020",
    title: "Bachelor's Degree",
    desc: "Earned my BCA from CCS University, Meerut. This is where my coding journey truly kicked off—building projects, exploring new tech, and realizing that Stack Overflow is a coder's best friend.",
    iconPath: "CCSU-Logo.jpg",
    path: "https://www.ccsuniversity.ac.in/",
  },
  {
    year: "2014",
    title: "Started Coding",
    desc: "Started coding in class 11 with HTML, thinking I was hacking the matrix. Built my first webpage with 'blink' tags and bright colors—because who needed UI/UX back then? That moment ignited my love for development!",
    iconPath: "dragon.png",
    path: "",
  },
  {
...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl mt-10 mx-auto px-4 md:px-8 py-10 z-10">
