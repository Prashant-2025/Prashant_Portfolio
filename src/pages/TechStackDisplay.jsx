...
const techCategories = [
  { 
    category: "Frontend", 
    theme: "neural",
    techs: ["HTML5", "CSS3", "JavaScript", "Tailwind", "Typescript", "Angular", "React"] 
  },
  { 
    category: "Backend", 
    theme: "terminal",
    techs: ["Node.js", "Express.js", "Redis"] 
  },
  { 
    category: "Database", 
    theme: "vortex",
    techs: ["MongoDB", "MySQL", "Firebase", "PostgreSQL", "GraphQL"] 
  },
  { 
    category: "Additional Skills", 
    theme: "ai",
    techs: ["AWS", "Docker", "Kubernetes", "Git", "MUI", "Redux"] 
  }
];
