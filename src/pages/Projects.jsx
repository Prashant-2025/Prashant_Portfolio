...
const projects = [
  {
    ...
    code: "",
    techstackused: "Angular, Node.js, MySQL, Express.js",
    techstackicons: ["html5", "css3", "angular", "nodejs", "mysql", "expressjs"],
  },
  {
    name: "Alco Foods",
    ...
    code: "",
    techstackused:
      "HTML5, CSS3, Javascript, Material-UI, React.js, Vite",
    techstackicons: ["html5", "css3", "js", "materialui", "reactjs", "vitejs"],
  },
  {
    name: "Portfolio",
  ...
  {
    name: "SMPPAS",
    desc: "A stock management application which creates a service agreement between customer and supplier.",
  ...
  },
  {
    ...
    code: "",
    techstackused: "HTML5, Tailwind, JavaScript, Material-UI, React.js, Vite",
    techstackicons: ["html5", "tailwind", "js", "materialui", "reactjs", "vitejs"],
  },
  {
    ...
    techstackicons: ["html5", "tailwind", "js", "reactjs", "nodejs", "expressjs", "mongodb"],
  },
  // {
  //   name: "VoteX",
