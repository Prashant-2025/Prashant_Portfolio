...
import { SiLeetcode, SiGeeksforgeeks, SiCodechef, SiFreelancer } from "react-icons/si";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto bg-black/60 backdrop-blur-md rounded-lg p-8 border border-amber-900/50">
        ...
        >
          Email: <span className="text-amber-400">thakurprashantbpt@gmail.com</span>
        </motion.p>
        ...
        >
          <SocialLink href="https://github.com/Prashant-2025" aria-label="GitHub">
            <FaGithub className="text-3xl md:text-4xl" />
          </SocialLink>
          
          <SocialLink href="https://www.linkedin.com/in/prashant-thakur-1a7039181/" aria-label="LinkedIn">
            <FaLinkedin className="text-3xl md:text-4xl" />
          </SocialLink>
          
          <SocialLink href="https://x.com/PrashantTh_8521" aria-label="Twitter">
            <FaTwitter className="text-3xl md:text-4xl" />
          </SocialLink>
          
          <SocialLink href="https://www.instagram.com/prashantrajput4764/" aria-label="Instagram">
            <FaInstagram className="text-3xl md:text-4xl" />
          </SocialLink>
          
          <SocialLink href="https://www.freelancer.com/u/prashant0032" aria-label="Freelancer">
            <SiFreelancer className="text-3xl md:text-4xl" />
          </SocialLink>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <motion.a
              href="mailto:thakurprashantbpt@gmail.com"
