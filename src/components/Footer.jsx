...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaGithub />, url: "https://github.com/Prashant-2025" },
    { icon: <FaTwitter />, url: "https://x.com/PrashantTh_8521" },
    { icon: <FaLinkedin />, url: "https://www.linkedin.com/in/prashant-thakur-1a7039181/" },
    { icon: <SiFreelancer />, url: "https://www.freelancer.com/u/prashant0032" }
  ];
  ...
  return (
    <footer className={`relative w-full px-4 md:px-8 py-6 flex flex-col items-center z-10 transition-all duration-300 ${
      ...
      <div className="relative">
        <p className="text-gray-400 text-sm">© Prashant Thakur</p>
